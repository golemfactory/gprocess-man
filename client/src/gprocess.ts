...
export const Request = {
  encode(
    ...
    switch (message.command?.$case) {
      case "start":
        StartRequest.encode(message.command.start, writer.uint32(18).fork())
          .ldelim();
        break;
      case "signal":
        SignalRequest.encode(message.command.signal, writer.uint32(26).fork())
          .ldelim();
        break;
      case "wait":
        WaitRequest.encode(message.command.wait, writer.uint32(34).fork())
          .ldelim();
        break;
      case "read":
        ReadRequest.encode(message.command.read, writer.uint32(42).fork())
          .ldelim();
        break;
      case "write":
        WriteRequest.encode(message.command.write, writer.uint32(50).fork())
          .ldelim();
        break;
    }
    return writer;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.command = {
            $case: "start",
            start: StartRequest.decode(reader, reader.uint32()),
          };
          continue;
        case 3:
          if (tag !== 26) {
          ...
          message.command = {
            $case: "signal",
            signal: SignalRequest.decode(reader, reader.uint32()),
          };
          continue;
        case 4:
          if (tag !== 34) {
          ...
          message.command = {
            $case: "wait",
            wait: WaitRequest.decode(reader, reader.uint32()),
          };
          continue;
        case 5:
          if (tag !== 42) {
          ...
          message.command = {
            $case: "read",
            read: ReadRequest.decode(reader, reader.uint32()),
          };
          continue;
        case 6:
          if (tag !== 50) {
          ...
          message.command = {
            $case: "write",
            write: WriteRequest.decode(reader, reader.uint32()),
          };
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<Request>, I>>(object: I): Request {
    ...
    if (
      object.command?.$case === "start" &&
      object.command?.start !== undefined && object.command?.start !== null
    ) {
      message.command = {
        $case: "start",
        start: StartRequest.fromPartial(object.command.start),
      };
    }
    if (
      object.command?.$case === "signal" &&
      object.command?.signal !== undefined && object.command?.signal !== null
    ) {
      message.command = {
        $case: "signal",
        signal: SignalRequest.fromPartial(object.command.signal),
      };
    }
    if (
      object.command?.$case === "wait" && object.command?.wait !== undefined &&
      object.command?.wait !== null
    ) {
      message.command = {
        $case: "wait",
        wait: WaitRequest.fromPartial(object.command.wait),
      };
    }
    if (
      object.command?.$case === "read" && object.command?.read !== undefined &&
      object.command?.read !== null
    ) {
      message.command = {
        $case: "read",
        read: ReadRequest.fromPartial(object.command.read),
      };
    }
    if (
      object.command?.$case === "write" &&
      object.command?.write !== undefined && object.command?.write !== null
    ) {
      message.command = {
        $case: "write",
        write: WriteRequest.fromPartial(object.command.write),
      };
    }
    return message;
  },
...
export const Response = {
  encode(
    ...
    switch (message.command?.$case) {
      case "start":
        StartResponse.encode(message.command.start, writer.uint32(18).fork())
          .ldelim();
        break;
      case "signal":
        SignalResponse.encode(message.command.signal, writer.uint32(26).fork())
          .ldelim();
        break;
      case "wait":
        WaitResponse.encode(message.command.wait, writer.uint32(34).fork())
          .ldelim();
        break;
      case "read":
        ReadResponse.encode(message.command.read, writer.uint32(42).fork())
          .ldelim();
        break;
      case "write":
        WriteResponse.encode(message.command.write, writer.uint32(50).fork())
          .ldelim();
        break;
      case "error":
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.command = {
            $case: "start",
            start: StartResponse.decode(reader, reader.uint32()),
          };
          continue;
        case 3:
          if (tag !== 26) {
          ...
          message.command = {
            $case: "signal",
            signal: SignalResponse.decode(reader, reader.uint32()),
          };
          continue;
        case 4:
          if (tag !== 34) {
          ...
          message.command = {
            $case: "wait",
            wait: WaitResponse.decode(reader, reader.uint32()),
          };
          continue;
        case 5:
          if (tag !== 42) {
          ...
          message.command = {
            $case: "read",
            read: ReadResponse.decode(reader, reader.uint32()),
          };
          continue;
        case 6:
          if (tag !== 50) {
          ...
          message.command = {
            $case: "write",
            write: WriteResponse.decode(reader, reader.uint32()),
          };
          continue;
        case 99:
          if (tag !== 794) {
  ...
  fromPartial<I extends Exact<DeepPartial<Response>, I>>(object: I): Response {
    ...
    if (
      ...
      message.command = {
        $case: "start",
        start: StartResponse.fromPartial(object.command.start),
      };
    }
    if (
      object.command?.$case === "signal" &&
      ...
      message.command = {
        $case: "signal",
        signal: SignalResponse.fromPartial(object.command.signal),
      };
    }
    if (
      object.command?.$case === "wait" && object.command?.wait !== undefined &&
      ...
      message.command = {
        $case: "wait",
        wait: WaitResponse.fromPartial(object.command.wait),
      };
    }
    if (
      object.command?.$case === "read" && object.command?.read !== undefined &&
      ...
      message.command = {
        $case: "read",
        read: ReadResponse.fromPartial(object.command.read),
      };
    }
    if (
      object.command?.$case === "write" &&
      ...
      message.command = {
        $case: "write",
        write: WriteResponse.fromPartial(object.command.write),
      };
    }
    if (
      object.command?.$case === "error" &&
      object.command?.error !== undefined && object.command?.error !== null
    ) {
      message.command = {
        $case: "error",
        error: Error.fromPartial(object.command.error),
      };
    }
    return message;
  },
  ...
  fromJSON(object: any): StartRequest {
    return {
      ...
      workDir: isSet(object.workDir)
        ? bytesFromBase64(object.workDir)
        : new Uint8Array(0),
      envClear: isSet(object.envClear)
        ? globalThis.Boolean(object.envClear)
        : false,
      env: globalThis.Array.isArray(object?.env)
        ? object.env.map((e: any) => Env.fromJSON(e))
        : [],
...
export const SignalRequest = {
  ...
  create<I extends Exact<DeepPartial<SignalRequest>, I>>(
    base?: I,
  ): SignalRequest {
...
export const WriteRequest = {
  ...
  create<I extends Exact<DeepPartial<WriteRequest>, I>>(
    base?: I,
  ): WriteRequest {
...
export const SignalResponse = {
  ...
  create<I extends Exact<DeepPartial<SignalResponse>, I>>(
    base?: I,
  ): SignalResponse {
...
export const WriteResponse = {
  ...
  create<I extends Exact<DeepPartial<WriteResponse>, I>>(
    base?: I,
  ): WriteResponse {
